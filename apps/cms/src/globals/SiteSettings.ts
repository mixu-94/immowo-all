          ...
          fields: [
            {
              ...
              label: 'Firma',
              required: true,
              defaultValue: 'Xunlai UG (haftungsbeschränkt)',
            },
            {
              name: 'addressLine1',
              type: 'text',
              label: 'Adresse (Zeile 1)',
              defaultValue: 'Drosselweg 7',
            },
            {
              name: 'addressLine2',
              type: 'text',
              label: 'Adresse (Zeile 2)',
              defaultValue: '86381 Krumbach, Deutschland',
            },
            { name: 'phone', type: 'text', label: 'Telefon' },
            { name: 'email', type: 'email', label: 'E-Mail', defaultValue: 'info@xunlai.io' },
