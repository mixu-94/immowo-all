...
export function RichTextRenderer({ content }: Props) {
  ...
  return (
    <div className="prose prose-invert max-w-none prose-p:leading-relaxed prose-p:text-white/80 prose-h2:mt-10 prose-h2:mb-4 prose-h2:text-xl prose-h2:font-semibold prose-h3:mt-8 prose-h3:mb-3 prose-h3:text-lg prose-h3:font-semibold prose-ul:my-4 prose-ol:my-4 prose-li:my-1 prose-li:text-white/80 prose-a:text-white prose-a:underline prose-a:decoration-white/30 hover:prose-a:decoration-white/60 prose-h2:border-b prose-h2:border-white/10 prose-h2:pb-3 prose-strong:text-white">
      {renderNode(root)}
    </div>
  );
}
