// components/kontakt/ContactShell.tsx
import type { ReactNode } from "react";

type Props = { children: ReactNode };

export function ContactShell({ children }: Props) {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[color:var(--color-bg)] text-[color:var(--color-text)]">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -top-56 left-1/2 h-[760px] w-[760px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(214,181,109,0.18),transparent_60%)] blur-3xl" />
